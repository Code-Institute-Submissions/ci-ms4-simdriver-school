...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        """
        Send the user a confirmation email about his/her order
        """
    ...
    def handle_event(self, event):
        """
        Handle a generic/unknown/unexpexted webhook event
        """
        return HttpResponse(
            content=f'Unhandled a webhook received: {event["type"]}',
            status=200)
